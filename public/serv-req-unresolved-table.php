	 ...
	 <?php
	 $dao = new Dao();
	 $urequests = $dao->getUserRequests(false);
	 $guest_requests = $dao->getGuestRequests(false);
...
<div class="tab-content" id="tab-all">
    <h2>Unresolved Service Requests</h2>
		...
		<thead>
			...
			<td>
				...
				>
				  ...
				  <input form=<?=$formid ?> type="hidden" name="page" value="serv-req-unresolved.php">
